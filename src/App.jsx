...
export default function SubtleTechie() {
  ...
  const getAnswer = (questionText) => {
    ...
    if (q.includes('encryption') && (q.includes('rest') || q.includes('transit') || q.includes('difference'))) {
    ...
    if (q.includes('zero trust') || q.includes('zero-trust')) {
    ...
    if ((q.includes('aws') || q.includes('azure') || q.includes('gcp')) && (q.includes('secure') || q.includes('best practice'))) {
    ...
    if (q.includes('iam') && q.includes('cloud')) {
    ...
    if (q.includes('shared responsibility') || (q.includes('cloud') && q.includes('responsibility'))) {
    ...
    if (q.includes('cloud') && (q.includes('threat') || q.includes('risk') || q.includes('vulnerability'))) {
    ...
    if (q.includes('vpc') || q.includes('virtual private cloud')) {
    ...
    if (q.includes('cloud') && q.includes('compliance')) {
    ...
    if (q.includes('cloudtrail') || q.includes('cloud') && q.includes('logging')) {
    ...
    if (q.includes('cloud') && (q.includes('backup') || q.includes('disaster recovery') || q.includes('dr'))) {
    ...
    if (q.includes('kubernetes') && q.includes('security')) {
    ...
    if (q.includes('serverless') && q.includes('security')) {
    ...
    if (q.includes('cloud') && q.includes('firewall')) {
    ...
    if (q.includes('container') && q.includes('security')) {
    ...
    if (q.includes('cloud') && (q.includes('cost') || q.includes('budget')) && q.includes('security')) {
    ...
    if (q.includes('multi-cloud') || q.includes('hybrid cloud')) {
    ...
    if (q.includes('cloud') && (q.includes('pen test') || q.includes('penetration') || q.includes('security testing'))) {
    ...
    if (q.includes('cloud access security broker') || q.includes('casb')) {
    ...
    if (q.includes('ai') && q.includes('security') && (q.includes('improve') || q.includes('help') || q.includes('benefit'))) {
    ...
    if (q.includes('ai') && (q.includes('threat') || q.includes('risk') || q.includes('danger'))) {
    ...
    if (q.includes('machine learning') && q.includes('security')) {
    ...
    if (q.includes('prompt injection') || q.includes('jailbreak')) {
    ...
    if (q.includes('deepfake') || q.includes('synthetic')) {
    ...
    if (q.includes('llm') && q.includes('security')) {
    ...
    if (q.includes('ai') && (q.includes('privacy') || q.includes('data protection'))) {
    ...
    if (q.includes('adversarial') && (q.includes('attack') || q.includes('example'))) {
    ...
    if (q.includes('ai model') && (q.includes('steal') || q.includes('theft') || q.includes('protect'))) {
    ...
    if (q.includes('ai') && q.includes('bias')) {
    ...
    if (q.includes('federated learning')) {
    ...
    if (q.includes('ai') && (q.includes('explainability') || q.includes('interpretability') || q.includes('transparency'))) {
    ...
    if (q.includes('ai') && (q.includes('governance') || q.includes('policy'))) {
    ...
    if (q.includes('ai') && q.includes('supply chain')) {
    ...
    if (q.includes('ai red team') || (q.includes('ai') && q.includes('penetration'))) {
    ...
    if (q.includes('ai') && (q.includes('regulation') || q.includes('compliance') || q.includes('law'))) {
    ...
    if (q.includes('ai') && (q.includes('phishing') || q.includes('social engineering'))) {
    ...
    if (q.includes('chatgpt') || q.includes('gpt') && q.includes('security')) {
    ...
    if (q.includes('ai') && (q.includes('malware') || q.includes('virus'))) {
    ...
    if (q.includes('autonomous') || (q.includes('ai') && q.includes('vehicle'))) {
    ...
    if (q.includes('password') && (q.includes('strong') || q.includes('create') || q.includes('best'))) {
    ...
    if (q.includes('multi-factor') || q.includes('mfa') || q.includes('2fa') || q.includes('two-factor')) {
    ...
    if (q.includes('vpn') && !q.includes('cloud')) {
    ...
    if (q.includes('firewall') && !q.includes('cloud')) {
    ...
    if (q.includes('antivirus') || q.includes('anti-virus') || q.includes('endpoint protection')) {
    ...
    if (q.includes('malware') && !q.includes('ai')) {
    ...
    if (q.includes('social engineering') && !q.includes('ai')) {
    ...
    if (q.includes('patch') || q.includes('update') && q.includes('security')) {
    ...
    if (q.includes('ddos') || q.includes('denial of service')) {
    ...
    if (q.includes('insider threat') || q.includes('insider attack')) {
    ...
    if (q.includes('data breach') || q.includes('breach response')) {
    ...
    if (q.includes('vulnerability') && (q.includes('scan') || q.includes('assessment'))) {
    ...
    if (q.includes('penetration test') || q.includes('pen test')) {
    ...
    if (q.includes('incident response') || q.includes('ir plan')) {
    ...
    if (q.includes('zero day') || q.includes('0day')) {
    ...
    if (q.includes('encryption') && !q.includes('cloud')) {
    ...
    if (q.includes('security') && (q.includes('framework') || q.includes('standard')) && !q.includes('cloud')) {
    ...
    if (q.includes('start') && q.includes('career') && (q.includes('cyber') || q.includes('security'))) {
    ...
    if (q.includes('certification') && (q.includes('cloud') || q.includes('security') || q.includes('cyber'))) {
    ...
    if (q.includes('security') && q.includes('salary')) {
    ...
    if (q.includes('learn') && (q.includes('cyber') || q.includes('security')) && !q.includes('career')) {
    ...
    if (q.includes('without') && q.includes('degree') && (q.includes('cyber') || q.includes('security') || q.includes('it'))) {
    ...
    if (q.includes('soc analyst') || q.includes('security analyst')) {
    ...
    if (q.includes('penetration test') && q.includes('career')) {
    ...
    if (q.includes('remote') && (q.includes('cyber') || q.includes('security') || q.includes('it'))) {
    ...
    if (q.includes('switch') && q.includes('cyber') && q.includes('career')) {
    ...
    if (q.includes('security') && (q.includes('interview') || q.includes('job interview'))) {
    ...
    if (q.includes('networking') && q.includes('it')) {
    ...
    if (q.includes('portfolio') && (q.includes('cyber') || q.includes('security') || q.includes('it'))) {
    ...
    if (q.includes('security') && (q.includes('specialize') || q.includes('specialization') || q.includes('focus'))) {
    ...
    if (q.includes('security') && q.includes('bootcamp')) {
    ...
    if (q.includes('programming') && (q.includes('security') || q.includes('cyber'))) {
    ...
    if (q.includes('stay current') || q.includes('keep up') && (q.includes('security') || q.includes('cyber'))) {
    ...
    if (q.includes('imposter syndrome') || (q.includes('not good enough') && q.includes('security'))) {
    ...
    if (q.includes('work-life balance') && (q.includes('security') || q.includes('it'))) {
    ...
    if (q.includes('security clearance') || q.includes('government') && (q.includes('cyber') || q.includes('security'))) {
    ...
    if (q.includes('freelance') || q.includes('consultant') && (q.includes('security') || q.includes('cyber'))) {
